...
<div class="container">
	<div class="col-md-2" style="border-right:solid 1px #ccc;">
		...
		<a href="<?php echo base_url("profile/address"); ?>" class="list-group-item">Address</a>
		<a href="<?php echo base_url("profile/account_details"); ?>" class="list-group-item">Account details</a>
		<a href="<?php echo base_url("home/logout"); ?>" class="list-group-item">Logout</a>
	</div>
