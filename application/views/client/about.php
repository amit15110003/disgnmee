...
<div class="container">
	<div class="col-md-offset-1 col-md-10">
			<h4>
				<b>The Hippogriff – Concept</b>
			</h4>
			<p style="padding-top: 25px;">Speak Art:</p>
			<p style="padding-top: 15px;">Everyone needs art. The Hippogriff brings together incredible art work from various genres to you as printed everyday use products. Art is not only accessible to all now, it’s affordable too. To express yourself through art is oddly satisfying. The creative intelligence and visual dexterity expressed through the lush arrangement of colours and inked ideas is celebrated with our quality products.</p>
			<p style="padding-top: 25px;">The Community:</p>
			<p style="padding-top: 15px;">We are building a strong community of talented artists from around the world. We collaborate with distinguished individuals who create unique hand drawn, oil painted, illustrated, photographed works of art that are then mocked up and displayed as their own products. The best part? Every sale helps pay an artist!</p>
			<p style="padding-top: 25px;">The Canvas:</p>
			<p style="padding-top: 15px;">The vision is to make individuals identify themselves with art. We want to print, paint and cover as many articles or products possible with exceptional artwork created by more and more artists. The Hippogriff is home for all future artists and their creations.</p>
			<h4 style="padding-top: 25px;">
				<b>The Hippogriff – Company</b>
			</h4>
			<p style="padding-top: 25px;">About :</p>
			<p style="padding-top: 15px;">The Hippogriff is a mythological creature that has the front portion of an eagle and hind portion of a horse. It is a majestic, powerful, fast, and inspiring – Everything that is synonymous to the brand’s identity and that is why it has been chosen as a symbol of the brand and all that it represents.</p>
