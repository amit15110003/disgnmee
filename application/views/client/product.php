...
<div class="container single-product">
	...
	<div class="col-md-5">
		...
		<?php $details=$this->user->showattribute($category);
		 ...
		 <?php $details=$this->user->showattribute($category);
		 foreach($details as $row ){if($row->attribute!="color"){?>
			<div class="col-md-6">
				<p><?php echo $row->attribute;?></p>
			...
			<div class="row">
		        ...
		        <div class="col-md-6 col-xs-12 btn-product" >
			            <?php if(!empty($this->session->userdata('uid'))){?>
			                <div class="" id="addcartbtn" ><button  class="btn col-md-12 col-xs-12" onclick="javascript:cartadd3(<?php echo $id;?>);"><span class="btn-text"> BUY NOW</span></button ></div>
			                <?php }else{?>
			                <div class="" id="addcartbtn" ><button  class="btn col-md-12 col-xs-12" onclick="javascript:cartadd4(<?php echo $id;?>);"><span class="btn-text">BUY NOW</span></button ></div>
			                <?php }?>
		        </div>
		        <div class="col-md-12 col-xs-12">
		        	<h4>Category:<small><span id="category"><?php echo $category; ?></span></small></h4>
		        	<h4>Tags</h4>
	  ...
	  <div class="tab-content">
	    ...
	    <div role="tabpanel" class="tab-pane active" id="comment">
	    	...
	    	<div class="col-md-8">
				...
				<h5><a data-toggle="modal" data-target=".login" style="font-size:16px;text-decoration:underline;color:#14ad8f;">Login</a> to comment</h5>
